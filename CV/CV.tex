...
Leading statistical analyses and teaching statistics in a collaborative setting, along with the development of methods for analyzing high-dimensional spatio-temporal data, based on concepts from signal processing.  I am most interested in analyzing associations between spatial locations and how these may change across time for geographical and neural imaging data.
\end{rSection}
