...
Leading statistical analyses and teaching statistics in a collaborative setting, along with developing methods for functional data analysis, incorporating concepts from signal processing.  I am most interested in applying these methods to analyze high-dimensional spatio-temporal data, particularly in medical imaging and geographical data.
\end{rSection}
