...
Links to previously recorded sessions are provided, as saved video files, along with R code.  Save script as **.R** NOT **.txt**.  Can also copy-paste text to script window in R.
GitHub repository for class for all sessions provided below; can download whole folder to get all scripts and supporting files (code, data, etc.).<br/>
